...
namespace PocoBuilder
{
    public static class DTOBuilder
    {
        ...
        public static bool VerifyDTOInterface<TInterface>()
        {
            ...
            // Any method, except those generated by properties or that have default implementations, is INVALID!
            if (allMethods.Where(m => (m.Attributes & MethodAttributes.SpecialName) == 0 || !(m.IsVirtual && m.IsPublic)).Any()) return false;
